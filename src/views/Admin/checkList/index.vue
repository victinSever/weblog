        ...
        <el-table-column label="操作" width="250" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              >详细信息</el-button
            >
            <el-button type="danger" size="mini" class="el-icon-delete" @click="handleDelete(scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...mapActions("admin", ["getHaveAuditedBlogs"]),

    async getData() {
      try {
        const { data: res } = await this.getHaveAuditedBlogs({
          ...this.pageMap,
        });
        console.log(res);
